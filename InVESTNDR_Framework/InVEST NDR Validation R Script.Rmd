...
sub title: "A Framework for validating the InVEST Nutrient Delivery Model (NDR) 
using long-term water quality data from monitoring stations"
author: "Valladares-Castellanos M, De Jesus Crespo R,  Xu J, Douthat T*"
reference: "Valladares-Castellanos M, De Jesus Crespo R,  Xu J, Douthat T. 2024. A Framework for validating the InVEST Nutrient Delivery Model (NDR) 
using long-term water quality data from monitoring stations. Science of the Total Environment (submitted). "
